    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <header className="border-b border-border bg-background/80 backdrop-blur-md sticky top-0 z-50">
                <div className="container mx-auto px-3 md:px-8 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <Button className="bg-primary hidden sm:inline-flex hover:bg-primary/90 shadow-lg">
                ...
                <div className="justify-end sm:hidden flex p-3 bg-gradient-to-r from-primary/10 to-accent/10 text-primary border-primary/20 border-[1px]">
                    <Button className="bg-primary  hover:bg-primary/90 shadow-lg">
                        <Link href="/lead-discovery">Get Started Free</Link>
                    </Button>
                </div>
            </header>
            ...
            <section className="relative py-24 px-8 overflow-hidden">
                ...
                <div className="container mx-auto text-center relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
                        <Button
                            size="lg"
                            className="bg-primary hover:bg-primary/90 text-lg px-10 py-4 shadow-xl"
                        >
                            Start Free Trial
                        ...
                        <Button
                            size="lg"
                            variant="outline"
                            className="text-lg px-10 py-4 border-2 hover:bg-muted bg-transparent"
                        >
                ...
                <div className="container mx-auto">
                    <div className="text-center mb-20">
                        ...
                        <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                            Advanced machine learning and automation tools
                            designed to transform how you discover, qualify, and
                            engage with prospects at scale.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <p className="text-xl text-muted-foreground mb-10 leading-relaxed">
                                Our AI identifies and engages only the
                                highest-quality prospects who are ready to buy.
                                No more spray-and-pray tactics or endless manual
                                research.
                            </p>
                ...
                <div className="container mx-auto">
                    <div className="text-center mb-20">
                        ...
                        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                            See how companies are transforming their sales with
                            LeadGen Pro
                        </p>
                    </div>
                    ...
                    <Card className="border-primary/20 bg-background/80 backdrop-blur-sm max-w-5xl mx-auto shadow-2xl">
                        <CardHeader className="pb-8">
                            ...
                            <CardDescription className="text-xl leading-relaxed max-w-3xl mx-auto">
                                ...
                                LeadGen Pro to scale their sales pipeline. Get
                                started with our free trial and see immediate
                                results.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="pb-12">
                            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-8">
                                <Button
                                    size="lg"
                                    className="bg-primary hover:bg-primary/90 text-lg px-12 py-4 shadow-xl"
                                >
                                    Start Free Trial
                                    <ArrowRight className="ml-3 h-6 w-6" />
                                </Button>
